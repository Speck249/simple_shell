...
/* _atoi.c >> function prototypes */
int _isalpha(int);
int is_delim(char, char *);
int interactive(info_t *);
int _atoi(char *);

/* _builtin.c >> function prototypes */
int _cd(info_t *);
int _exit(info_t *);
int _help(info_t *);

/* _builtin_1.c >> function prototypes */
...
/* error.c >> function prototypes */
void _eputs(char *);
int _eputchar(char);
int _putfd(char c, int fd);
int _putsfd(char *str, int fd);

/* error_1.c >> function prototypes */
int _erratoi(char *);
...
/** realloc.c >> function prototypes **/
char *_memset(char *, char, unsigned int);
void ffree(char **);
void *_realloc(void *, unsigned int, unsigned int);

/** shell_loop.c >> function prototypes **/
int hsh(info_t *, char **);
...
/** string_1.c >> function prototypes **/
char *_strcpy(char *, char *);
char *_strdup(const char *);
void _puts(char *);
int _putchar(char);

/** tokenizer.c >> function prototypes **/
